...
export class PresidenteDetalhes extends Component {
  ...
  getCandidatoDetalhe = async () => {
    ...
    const api_call = await fetch(`http://divulgacandcontas.tse.jus.br/divulga/rest/v1/candidatura/buscar/2018/BR/2022802018/candidato/${id_candidato}`)
...
export default PresidenteDetalhes
